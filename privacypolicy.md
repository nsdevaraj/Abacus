...
- **Application** refers to AbacusGame, the software program provided by the Company.
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to  AbacusGame.
...
- **By visiting this page on our website:** [https://github.com/nsdevaraj/abacus/issues](https://github.com/nsdevaraj/abacus/issues)
